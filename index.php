                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-md-col-xl-6 mb-md-0 mb-sm-4 mb-4 tm-site-header-col">
                        <div class="tm-site-header">
                            <h1 class="mb-4" style="font-weight: 900; font-size:50px; text-shadow: 3px 3px #140033;"><b>DM Hospital</b></h1>
                            <img src="img/underline.png" class="img-fluid mb-4">
                            <p style="font-weight: 900; text-shadow: 2px 2px #140033;">Your Health,Our Responsiblity</p>
                        </div>
                    </div>
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product">
                                        ...
                                        <div class="product__description">
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    <h2 class="tm-page-title">About Us</h2>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product__description">
                                            <div class="p-sm-4 p-2">
                                                <div class="row mb-3">
                                                    <div class="col-12">
                                                        <h2 class="tm-page-title"> Team</h2>
                                                    </div>
                                                </div>
                                                <div class="row tm-reverse-sm">
                                                    <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                                        <p class="mb-4">Here are the emergency and other contact details required :</p>
                                                        <p class="mb-4">Hospital Reception : 11111 11111 <br> Hospital ER attending : 22222 22222 <br> Our Email id : dmhospital@gmail.com</p>
                                                        <p class="mb-5">COVID-19 helpline : 1075 <br> Our ambulance service : 33333 33333</p>
...
.button4 {padding: 42px 35px;}

</style><a href="login.php" style="font-weight: 300px;"><button class=" button button4 product"><i class="fas fa-sign-in-alt fa-3x tm-nav-icon"></i>
            ...
            <footer>
                <p class="small tm-copyright-text">welcome !!!</p>
            </footer>
        </div> <!-- .tm-main-content -->
    </div>
    <!-- load JS -->
